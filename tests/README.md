...
`mode` 可使用 `title`、`map`、`battle`、`battle_action`、`battle_dead_board`、`reward`、`build`、`settlement`；battle 會建立五名敵人的同列壓力測試畫面，battle_action 會在第一名敵人結算時擷取，battle_dead_board 則擷取死盤紅色掃描的波峰。
```
