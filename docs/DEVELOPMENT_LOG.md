...
- MetaState 升至 v2，最近 20 局另存勝敗、原因、seed、節點／戰鬥進度、剩餘 HP／Sanity／MP／金錢與結束時間；v1 profile 可自動遷移。
- 地圖提示直接顯示本局 seed，方便玩家回報與重現；內容驗證新增 seed 模式、編輯器啟動策略與歷史上限欄位。
- 自動測試新增隨機／固定 seed 策略、歷史上限、round-trip、摘要嚴格驗證與 Meta v1→v2 遷移案例。
