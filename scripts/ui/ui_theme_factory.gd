...
static func build(document: Dictionary) -> Theme:
	...
	theme.set_stylebox("panel", "PanelContainer", _box(panel, border, radius, border_width, 18))
	theme.set_stylebox("panel", "TooltipPanel", _box(panel, accent, radius, 1, 12))
	theme.set_stylebox("normal", "Button", _box(panel, border, radius, border_width, 12))
	theme.set_stylebox("hover", "Button", _box(hover, accent, radius, border_width, 12))
	theme.set_stylebox("pressed", "Button", _box(palette.get("accent_dark", "#8B6532"), accent, radius, border_width, 12))
	theme.set_stylebox("disabled", "Button", _box(panel.darkened(0.3), border.darkened(0.35), radius, 1, 12))
